    ...
    <nav className={`sticky top-0 z-50 ${page === 'user' ? 'bg-card shadow-sm' : ''}`}>
            <div className="flex flex-wrap items-center justify-between mx-auto p-3">
                ...
                <div className="flex gap-2">
                    <Button variant="outline" size="icon" className={isLibraryPage ? "opacity-50 pointer-events-none" : ''} asChild>
                    ...
                    {page === 'user' ? (
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="w-40">
                                <DropdownMenuLabel className='text-primary font-bold'>My Account</DropdownMenuLabel>
                                <DropdownMenuSeparator />
                                <DropdownMenuItem className='hover:cursor-pointer' asChild>
                                    <a href="/setting"> <CircleUserRound className=''/> Profile </a>
                                </DropdownMenuItem>
                                <DropdownMenuItem asChild>
                                    <a href="/setting"> <Settings/> Setting </a>
                                </DropdownMenuItem>
                                <DropdownMenuItem variant='destructive' className='hover:cursor-pointer' asChild>
