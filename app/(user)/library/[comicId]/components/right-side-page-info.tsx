    ...
    <TooltipProvider>
      <div className="custom-scrollbar flex h-full w-full flex-col overflow-y-auto pr-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="mt-2">
            <h1 className="mb-1 text-lg font-semibold">More Info</h1>
            <div className="flex flex-col gap-1">
              ...
              <p className="text-muted-foreground text-sm font-semibold">
                Status:{' '}
                <span className="text-foreground">{data?.status || 'N/A'}</span>
              </p>
              <p className="text-muted-foreground text-sm font-semibold">
                Chapter:{' '}
                <span className="text-foreground">
        ...
        <div className="flex flex-col gap-4">
          ...
          {relatedComics.length > 0 && (
            <div>
              <h1 className="text-md mb-1 font-semibold">Relation</h1>
