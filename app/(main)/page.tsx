			...
			<div className="relative isolate">
				...
				>
					...
					<p className="mt-8 w-[55%] text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">
						...
						myself to create something simple, functional, and
						meaningful for me.
					</p>
				</section>
				...
				<section id="about">
					<div className="mx-auto mt-2 max-w-screen-xl items-center gap-16 px-4 py-8 lg:grid lg:grid-cols-2 lg:px-6 lg:py-16">
						...
						<div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
							...
							<p className="mb-4">
								This project started as a simple idea: to create
								a personal system for managing my book
								collection. It’s my first independent project
								after completing a full-stack development
								program, built to challenge myself and to apply
								the skills I’ve learned.
							</p>
							<p>
								The goal was to keep it simple yet functional.
								Along the way, I gained hands-on experience in
								building with React and Tailwind CSS,
								structuring a backend, and turning an idea into
								a working application. For me, this project
								represents an important milestone in my journey
								as a developer.
							</p>
						</div>
						...
						<div className="grid gap-12 lg:grid-cols-2">
							...
							<div className="rounded-lg border border-gray-200 bg-white p-6 shadow-md dark:border-gray-700 dark:bg-gray-800">
								...
								<p className="mb-4 text-gray-600 dark:text-gray-400">
									...
									my personal book collection while applying
								...
								<p className="mb-2 text-gray-600 dark:text-gray-400">
									...
									independently — from frontend (React +
									Tailwind) to backend integration and
									deployment.
								</p>
							...
							<div className="rounded-lg border border-gray-200 bg-white p-6 shadow-md dark:border-gray-700 dark:bg-gray-800">
								...
								<p className="mb-2 text-gray-600 dark:text-gray-400">
									...
									Developed the backend APIs for course and
									schedule management, and built instructor
									dashboard components using React. I also
									helped integrate authentication and
