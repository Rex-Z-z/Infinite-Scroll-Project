      ...
      <div className="flex flex-col p-4">
        ...
        <section>
          <Tabs defaultValue="ongoing" className="w-full">
            <TabsList className="mb-2 gap-1 bg-">
              <TabsTrigger value="ongoing" className='p-5 dark:data-[state=active]:bg-blue-600'>
                <CalendarCog /> Ongoing
              </TabsTrigger>
              <TabsTrigger value="completed" className='p-5 dark:data-[state=active]:bg-blue-600'>
                <Settings2 /> Completed
              </TabsTrigger>
              <TabsTrigger value="hold" className='p-5 dark:data-[state=active]:bg-blue-600'>
                <Settings2 /> On Hold
              </TabsTrigger>
              <TabsTrigger value="dropped" className='p-5 dark:data-[state=active]:bg-blue-600'>
                <Settings2 /> Dropped
              </TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="ongoing">
              <div>
                {loading && <div className="flex flex-row gap-2"><SectionSkeleton /></div>}
